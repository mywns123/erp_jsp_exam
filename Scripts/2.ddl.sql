...
CREATE TABLE erp_jsp_exam.DEPARTMENT (
	DEPT_NO   INTEGER(2)  NOT NULL COMMENT '부서번호', -- 부서번호
	DEPT_NAME VARCHAR(20) NULL     COMMENT '부서명', -- 부서명
	FLOOR     INTEGER(2)  NULL     COMMENT '위치' -- 위치
)
COMMENT '부서';
...
CREATE TABLE erp_jsp_exam.TITLE (
	TITLE_NO   INTEGER(2)  NOT NULL COMMENT '직책번호', -- 직책번호
